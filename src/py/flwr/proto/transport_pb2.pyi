...
class PaillierPublicKey(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    G_FIELD_NUMBER: builtins.int
    MAX_INT_FIELD_NUMBER: builtins.int
    N_FIELD_NUMBER: builtins.int
    NSQUARE_FIELD_NUMBER: builtins.int
    g: builtins.int = ...
    max_int: builtins.int = ...
    n: builtins.int = ...
    nsquare: builtins.int = ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"g",b"g",u"max_int",b"max_int",u"n",b"n",u"nsquare",b"nsquare"]) -> None: ...
global___PaillierPublicKey = PaillierPublicKey
...
class ServerMessage(google.protobuf.message.Message):
    ...
    class SendPublicKey(google.protobuf.message.Message):
        DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
        PUBLIC_KEY_FIELD_NUMBER: builtins.int

        @property
        def public_key(self) -> global___PaillierPublicKey: ...

        def __init__(self,
            *,
            public_key : typing.Optional[global___PaillierPublicKey] = ...,
            ) -> None: ...
        def HasField(self, field_name: typing_extensions.Literal[u"public_key",b"public_key"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal[u"public_key",b"public_key"]) -> None: ...

    RECONNECT_FIELD_NUMBER: builtins.int
    GET_PARAMETERS_FIELD_NUMBER: builtins.int
    FIT_INS_FIELD_NUMBER: builtins.int
    EVALUATE_INS_FIELD_NUMBER: builtins.int
    SEND_PUBLIC_KEY_FIELD_NUMBER: builtins.int
    ...
    @property
    def send_public_key(self) -> global___ServerMessage.SendPublicKey: ...
    ...
    def __init__(self,
        *,
        ...
        send_public_key : typing.Optional[global___ServerMessage.SendPublicKey] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal[u"evaluate_ins",b"evaluate_ins",u"fit_ins",b"fit_ins",u"get_parameters",b"get_parameters",u"msg",b"msg",u"reconnect",b"reconnect",u"send_public_key",b"send_public_key"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"evaluate_ins",b"evaluate_ins",u"fit_ins",b"fit_ins",u"get_parameters",b"get_parameters",u"msg",b"msg",u"reconnect",b"reconnect",u"send_public_key",b"send_public_key"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"msg",b"msg"]) -> typing_extensions.Literal["reconnect","get_parameters","fit_ins","evaluate_ins","send_public_key"]: ...
...
class ClientMessage(google.protobuf.message.Message):
    ...
    class ReceivePublicKey(google.protobuf.message.Message):
        DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
        PUBLIC_KEY_FIELD_NUMBER: builtins.int
    ...
    RECEIVE_PUBLIC_KEY_FIELD_NUMBER: builtins.int
    ...
    @property
    def receive_public_key(self) -> global___ClientMessage.ReceivePublicKey: ...
    ...
    def __init__(self,
        *,
        ...
        receive_public_key : typing.Optional[global___ClientMessage.ReceivePublicKey] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal[u"disconnect",b"disconnect",u"evaluate_res",b"evaluate_res",u"fit_res",b"fit_res",u"msg",b"msg",u"parameters_res",b"parameters_res",u"receive_public_key",b"receive_public_key"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"disconnect",b"disconnect",u"evaluate_res",b"evaluate_res",u"fit_res",b"fit_res",u"msg",b"msg",u"parameters_res",b"parameters_res",u"receive_public_key",b"receive_public_key"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"msg",b"msg"]) -> typing_extensions.Literal["disconnect","parameters_res","fit_res","evaluate_res","receive_public_key"]: ...
